...
\item[(a)] Prove that there are two polynomials \(P\) and \(Q\) such that \(f(z) = \displaystyle \frac {P(z)}{Q(z)} \) for all \(z\in\mathbb{C}-\{0,1\}\).

\item[(b)] Prove that for all \(z\in \mathbb{C}-\{0,1\}\) we have
