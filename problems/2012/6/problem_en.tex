...
Homer's goal is to make \(f(x)\) divisible by a fixed polynomial \(m(x)\) and Albert's goal is to prevent this.\begin{itemize}

\item[(a)] Which of the players has a winning strategy if \(m(x)=x-2012\)?
\item[(b)] Which of the players has a winning strategy if \(m(x)=x^2+1\)?
\end{itemize}
