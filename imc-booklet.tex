\documentclass[10pt,a4paper,twoside=false,parskip=half]{scrbook}
    ...
    for _, year in ipairs(collect_years()) do
        ...
        for _, problem in ipairs(collect_problems(year)) do
            ...
            if file then
                ...
                tex.print("\\par\\medskip\\noindent\\textbf{Problem " .. problem_heading(year, problem) .. ".}")
...
\directlua{imc_language = "\IMCLanguage"}
...
{\Huge\bfseries IMC Problem Booklet\par}
\vspace{1.5em}
{\large This booklet contains problems from the International Mathematics Competition for University Students.\par}
\vspace{1.5em}
{\large \url{https://www.imc-math.org.uk/}\par}
\vfill
{\small All problems belong to the International Mathematics Competition for University Students.\par}
\end{titlepage}
